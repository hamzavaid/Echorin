...
class SimulationControls(QGroupBox):
    ...
    vectors_toggled = Signal(bool)
    uncertainty_toggled = Signal(bool)
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.labels_checkbox = QCheckBox("Track labels")
        self.vectors_checkbox = QCheckBox("Velocity vectors")
        self.uncertainty_checkbox = QCheckBox("95% uncertainty")
        for column, checkbox in enumerate(
            (self.labels_checkbox, self.vectors_checkbox,
             self.uncertainty_checkbox)
        ):
            checkbox.setChecked(True)
            layout.addWidget(checkbox, 2, column)
        ...
        layout.addWidget(QLabel("dt"), 3, 2)
        layout.addWidget(self.dt_spin, 3, 3)
        ...
        layout.addWidget(QLabel("Noise σ"), 4, 2)
        layout.addWidget(self.noise_spin, 4, 3)
        self.waveform_combo = QComboBox()
        self.waveform_combo.addItems(("LFM", "Rectangular"))
        layout.addWidget(QLabel("Waveform"), 5, 0)
        layout.addWidget(self.waveform_combo, 5, 1)
        self.preset_combo = QComboBox()
        self.preset_combo.addItems(("Crossing", "Single target"))
        layout.addWidget(QLabel("Preset"), 5, 2)
        layout.addWidget(self.preset_combo, 5, 3)
        ...
        self.vectors_checkbox.toggled.connect(self.vectors_toggled)
        self.uncertainty_checkbox.toggled.connect(self.uncertainty_toggled)
